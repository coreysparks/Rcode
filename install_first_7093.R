...
install.packages(c("devtools", "tidyverse", "car", "Hmisc", "knitr", "lattice","spatialreg",  "survey", "ctv","ggplot2", "acs", "ggmap", "dplyr", "sjPlot", "acs", "tigris", "spdep", "RSAGA", "sf", "tidycensus"), dependencies = T)
