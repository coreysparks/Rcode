...
Here are the basic Binomial (y,n) model and the basic Poisson models. The correction of the p-values in the Poisson model comes from Prof. German Rodrıguez's notes [Link](http://data.princeton.edu/wws509/notes/c4a.pdf). 
...
```{r mods2}
fit.nblm<-glm.nb(deaths~offset(log(population))+age+ pblack_1+phisp+ppersonspo+ppopmarrie+DISSWB, data=dat@data)
summary(fit.nblm)
