...
load("~/Documents/GitHub/county_age_estimates.Rdata")
est65<-ests[ests$AGEGROUP==26,]
total<-ests[ests$AGEGROUP==0,]
...
dat2<-read.csv("~/Documents/GitHub//COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv") #deaths
